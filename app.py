# -*- coding: utf-8 -*-
"""7_Despliegue-Videojuegos con Streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lIVh-n5ZFF4LZ1agsOQ85kcAC67Rpavq
...
#Cargamos el modelo
import pickle
filename = 'modelo-reg-videojuegos.pkl'
modelo, min_max_scaler, variables = pickle.load(open(filename, 'rb'))

#Cargamos los datos futuros, este CSV lo reemplazamos por el Formulario
...
#En los despliegues no se quitan las dummies, por eso drop_first=False
...
#Y_pred = modelo.predict(data_preparada) Esto falla porque teniamos dummies que los datos futuros no tienen

#Se adicionan las columnas faltantes, las que hacian falta las llena con 0
...
#No hay porqué normalizar porque el árbol no se normaliza
...
st.warning("El modelo tiene un error del 4.7%")